...
$(document).ready(function () {
    ...
    $(document).on('submit','#frmUptAccessType',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/update_order_type",
            data: formData,
            cache: false,
            contentType:false,
            processData:false,
    ...
    $(document).on('click','#dataID', function(){
        ...
        $.ajax({
            type: "get",
            url: "settings/find_single_item_order_type",
            data: {'id' : id},
            success: function (data) {
    ...
    $(document).on('click','#btnDelete',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/order_type-delete",
            data: {'id' : id},
            success: function (data) {
