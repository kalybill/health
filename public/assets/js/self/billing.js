    ...
    columns: [
        ...
        { 
            ...
            render: function (data, type, row, meta) {
                return row.pay_period_1 + ' to ' + row.pay_period_2;
            }
        },
        { data: "visit_type" },
        { data: "nurse" },
...
$(document).ready(function () {
    ...
    $(document).on("click", "#btnEdit", function () {
        ...
        $.ajax({
            type: "post",
            url: "medrecords/get_md_billings",
            data: { id: id },
    ...
    $(document).on("submit", "#frmBilling", function () {
        var formData = new FormData(this);

        $.ajax({
            type: "post",
            url: "medrecords/save_billing",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
