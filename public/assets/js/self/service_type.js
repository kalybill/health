...
$(document).ready(function () {
    ...
    $(document).on('click','#btnEdit',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/edit_service_type",
            data: {'id': id},
            success: function (data) {
                $('#mdBody').html(data)
            }
    ...
    $(document).on('submit','#frmUptAccessType',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/update_service_type",
            data: formData,
            cache: false,
            contentType:false,
            processData:false,
    ...
    $(document).on('click','#dataID', function(){
        ...
        $.ajax({
            type: "get",
            url: "settings/find_single_item_service_type",
            data: {'id' : id},
            success: function (data) {
    ...
    $(document).on('click','#btnDelete',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/referral_service_type",
            data: {'id' : id},
            success: function (data) {
