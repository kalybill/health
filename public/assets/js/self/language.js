...
$(document).ready(function () {
    ...
    $(document).on('click','#dataID', function(){
        ...
        $.ajax({
            type: "get",
            url: "settings/find_single_item_pump",
            data: {'id' : id},
            success: function (data) {
