...
$(document).ready(function () {
    $(document).on('submit','#frmAccessType',function () { 
        var formData = new FormData(this);
        
        $.ajax({
            type: "post",
            url: "settings/access-type",
            data: formData,
            cache: false,
            contentType:false,
            processData:false,
    ...
    $(document).on('submit','#frmUptAccessType',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/update_access_type",
            data: formData,
            cache: false,
            contentType:false,
            processData:false,
