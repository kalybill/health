...
$(document).ready(function () {
    ...
    $(document).on('click','#dataID', function(){
        ...
        $.ajax({
            type: "get",
            url: "settings/find_single_item_case_type",
            data: {'id' : id},
            success: function (data) {
    ...
    $(document).on('click','#btnDelete',function () { 
        ...
        $.ajax({
            type: "post",
            url: "settings/referral_case_type",
            data: {'id' : id},
            success: function (data) {
