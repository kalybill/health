@php
    use App\Models\{Referral,Scheduling,Nurse_geographical,Nurse};
@endphp
@extends('layouts.app')
...
@section('body')
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                            ...
                            <h3 class="card-title align-items-start flex-column text-white pt-15">
                                <span class="fw-bold fs-2x mb-3">Hello, {{ Auth::user()->name }}</span>
                            ...
                            <div class="mt-n20 position-relative">
                                ...
                                <div class="row g-3 g-lg-6">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                    ...
                                                    <div class="m-0">
                                                        <!--begin::Number-->
                                                        <span
                                                            class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ Referral::referrals_count(4) }}</span>
                                                        <!--end::Number-->
                                                        <!--begin::Desc-->
                                                        <span class="text-gray-500 fw-semibold fs-6">Active Patient</span>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Stats-->
                                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ Scheduling::visit_today() }}</span>
                                                    <!--end::Number-->
                                                    <!--begin::Desc-->
                                                    <a href="{{ url('reports/visit-report') }}"><span class="text-gray-500 fw-semibold fs-6">Number of visit today</span></a>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                        ...
                                        <div class="col-6 mt-5">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--end::Number-->
                                                    <!--begin::Desc-->
                                                    <a href="{{ url('reports/patient-auth-report') }}"><span class="text-gray-500 fw-semibold fs-6">Authorization</span></a>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                        ...
                                        <div class="col-6 mt-5">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--end::Number-->
                                                    <!--begin::Desc-->
                                                    <span class="text-gray-500 fw-semibold fs-6">Test</span>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="javascript:void(0)" id="frmSearchLocationRN">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="">RN Name</label>
                                                            <select name="search_rn" id="search_rn" class=" form-select" data-control="select2">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="search_location" id="search_location" class=" form-select" data-control="select2">
                                                                <option value="">Pls Select</option>
                                                                @foreach (Nurse_geographical::all() as $item)
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-5" id="kt_docs_fullcalendar_selectable"></div>
                </div>
            </div>
        </div>
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/js/self/dashboard.js') . env('VERSION') }}"></script>
