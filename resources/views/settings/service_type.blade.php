...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="float-end"><button class=" btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-plus fa-xl"></i> New Service Type</button></div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" data-parsley-validate id="frmReferral">
                       <div class="row">
                        <div class="col-md-12">
                            <label for="">Service Type Description</label>
    ...
    <div class="modal fade" id="mdEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Update Service Type</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@section('scripts')
<script src="{{ asset('assets/js/self/service_type.js') }}"></script>
    <script>
        $('#navServiceType').addClass('active')
    </script>
@endsection
