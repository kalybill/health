        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">New Referral Source</h1>
...
@section('scripts')
<script src="{{ asset('assets/js/self/referral_source.js') }}"></script>
    <script>
        $('#navReferralSource').addClass('active')
    </script>
@endsection
