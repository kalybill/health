...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="float-end"><button class=" btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-plus fa-xl"></i> New Access Type</button></div>
        </div>
    </div>
...
@section('scripts')
<script src="{{ asset('assets/js/self/access_type.js') }}"></script>
    <script>
        $('#navAccessType').addClass('active')
    </script>
@endsection
