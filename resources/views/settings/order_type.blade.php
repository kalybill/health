...
<div class="row">
    <div class="col-md-12">
        <div class="float-end"><button class=" btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-plus fa-xl"></i> New Order Type</button></div>
    </div>
</div>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">New Order Type</h1>
        ...
        <div class="modal-body">
            <form action="javascript:void(0)" data-parsley-validate id="frmPump">
               <div class="row">
                <div class="col-md-12">
                    <label for="">Order Type Description</label>
...
<div class="modal fade" id="mdEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Update Order Type</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Delete Order Type</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@section('scripts')
<script src="{{ asset('assets/js/self/order_type.js') }}"></script>
<script>
    $('#navOrderType').addClass('active')
</script>
@endsection