...
class OrderTypeController extends Controller
{
    public function index(){
        ...
        return view('settings.order_type');
    }

    public function save_order_type(Request $req){
        $rules = [
    ...
    public function dt_order_type(Request $req){
        $access = Order_type::all();
    ...
    public function edit_order_type(Request $req){
        $data = Order_type::find($req->id);
