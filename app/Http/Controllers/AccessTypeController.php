...
class AccessTypeController extends Controller
{
    public function index(){
        ...
        return view('settings.access_type');
    }

    public function save_access_type(Request $req){
        $rules = [
    ...
    public function dt_access_types(Request $req){
    ...
    public function edit_access_type(Request $req){
        $data = Access_type::find($req->id);
    ...
    public function delete(Request $req){
        $delete = Access_type::find($req->id);
