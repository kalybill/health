...
class ServiceTypeController extends Controller
{
    public function index(){
        ...
        return view('settings/service_type');
    }

    public function save_service_type(Request $req){
        $rules = [
    ...
    public function dt_service_type(Request $req){
        $access = Service_type::all();
    ...
    public function edit_service_type(Request $req){
        $data = Service_type::find($req->id);
    ...
    public function delete(Request $req){
        $delete = Service_type::find($req->id);
