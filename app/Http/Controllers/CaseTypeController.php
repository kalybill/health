...
class CaseTypeController extends Controller
{
    public function index(){
        ...
        return view('settings/case_type');
    }

    public function save_case_type(Request $req){
        $rules = [
    ...
    public function dt_case_type(Request $req){
        $access = Case_type::all();
    ...
    public function edit_case_type(Request $req){
        $data = Case_type::find($req->id);
