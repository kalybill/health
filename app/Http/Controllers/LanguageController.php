...
class LanguageController extends Controller
{
    ...
    public function save_language(Request $req)
    {
        $rules = [
    ...
    public function dt_language(Request $req)
    {
        $access = Language::all();
    ...
    public function edit_language(Request $req)
    {
